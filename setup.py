...
try:
    readme = io.open(os.path.join(pkg_root, 'README.rst'), encoding='utf-8').read()
except IOError:
    readme = ''
...
setup(
    ...
    install_requires=['PyYAML==3.12d', 'unidecode'],
    dependency_links=['https://github.com/bitshark/pyyaml/zipball/3.12d#egg=pyyaml-3.12d'],
